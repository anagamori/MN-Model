...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "pntproc");
 	...
 	ivoc_help("help ?1 VClamp /home/hines/neuron/nrnmpi/src/nrnoc/../../../nrn/src/nrnoc/vclmp.mod\n");
...
double icur (  ) {
 ...
 if(error){fprintf(stderr,"at line 141 in file ../../../nrn/src/nrnoc/vclmp.mod:\n		SOLVE clamp\n"); nrn_complain(_p); abort_run(error);}
 _licur = ( vo - v ) / rstim ;
     }
...
{
 { error =  update();
 if(error){fprintf(stderr,"at line 111 in file ../../../nrn/src/nrnoc/vclmp.mod:\n	SOLVE update METHOD after_cvode : but not really (see above)\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "../../../nrn/src/nrnoc/vclmp.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
